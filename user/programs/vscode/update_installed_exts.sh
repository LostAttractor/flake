...
do
if [[ "$i" != @("bbenoist.nix"|"jnoortheen.nix-ide"|"ms-python.python"|"ms-python.debugpy"|"ms-vscode-remote.remote-ssh"|"ms-vscode.cpptools"|"ms-vscode.cmake-tools"|"rust-lang.rust-analyzer") ]]; then
